from pyaccsharedmemory import accSharedMemory, ACC_SESSION_TYPE, ACC_STATUS
...
#=============================================================================================================================
    def tray_func(self):
        self.tray_icon = Image.open(self.get_path("assets/acc_rp_icon.ico"))
        self.tray_app = pystray.Icon("ACC Rich Presence", self.tray_icon, menu=pystray.Menu(
            pystray.MenuItem("LFM Integration", self.lfm_integration_window),
            pystray.MenuItem("Exit", self.close_rp)
        ))
...
#=============================================================================================================================
    def check_process_status(self):
        ...
        if "AC2-Win64-Shipping.exe" in list and self.acc_running == False: 
            self.acc_running = True
        elif "AC2-Win64-Shipping.exe" not in list and self.acc_running == True:
        ...
        if self.acc_running == True:
            if "Discord.exe" in list and self.discord_connected == False:
                while self.discord_connected == False:
                    try:
                        self.rich_presence.connect()
                        self.discord_connected = True
                    except: 
                        time.sleep(1)
            elif "Discord.exe" not in list and self.discord_connected == True: self.discord_connected = False
#=============================================================================================================================
